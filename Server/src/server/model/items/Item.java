...
public class Item {
    ...
    public static int platebody[] = {15593,13858,10338,7608,2520,430,636, 638, 640, 642, 644, 426, 8031, 8027, 6617, 8019, 8014, 8002, 544, 577, 7974, 7970, 7965, 7961, 7960, 3793, 3773, 3775, 3771, 3769, 3767, 6139, 1035, 540, 5553, 4757, 1833, 1835, 6388, 6384, 4111, 4101, 4868, 4869, 4870, 4871, 4892, 4893, 4894, 4895, 4916, 4917, 4918, 4919, 4940, 4941, 4942, 4943, 4964, 4965, 4966, 4967, 4988, 4989, 4990, 0x2f9a0eb, 6186, 6184, 6180, 3058, 4509, 4504, 4069, 4728, 4736, 4712, 6107, 2661, 3140, 1115, 1117, 1119, 1121, 1123, 1125, 1127, 2583, 2591, 2599, 2607, 2615, 6322, 2623, 2653, 2669, 3481, 4720, 4728, 4749, 2661, 6129, 6916, 4091, 6654, 6133, 75, 7399, 7390, 5575, 6341, 6351, 3387, 5030, 5032, 5034, 7392};
    
	/* Fullbody is an item that covers your arms. */
    private static String[] fullbody = {"Shirt","shirt","Vesta's chainbody","Morrigan's leather body","Vesta's Chainbody","Rock-shell plate","Wizard robe (t)","Vesta's platebody","Primal Platebody","zamorak robe","Dragon Platebody","top","shirt","platebody","Ahrims robetop","Karils leathertop","brassard","Robe top","robetop","platebody (t)","platebody (g)","chestplate","torso", "hauberk", "Dragon chainbody"};
    /* Fullhat covers your head but not your beard. */
    private static String[] fullhat = {"Statius's Full Helm","Full slayer helmet","full slayer helm","cowl","Pernix cowl","Pernix mask","med helm","coif","Dharok's helm","hood","Initiate helm","Coif","Helm of neitiznot","Armadyl helmet","Berserker helm", "Archer helm", "Farseer helm", "Warrior helm", "Void"};
    /* Fullmask covers your entire head. */
    private static String[] fullmask = {"Morrigan's coif","pernix mask","cowl","Pernix cowl","Pernix mask","Primal Full Helm","Cat mask","Sheep mask","Wolf mask","Full slayer helmet","full helm","mask","Verac's helm","Guthan's helm","Karil's coif","mask","Torag's helm", "Void", "sallet"};
	...
	static {
		...
		int[] stackableItems = {299,7119,15273,13879,13883,13957,18016,12158,12159,12159,12160,12163,12155,15016,15243};
