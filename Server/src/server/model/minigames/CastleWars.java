...
public class CastleWars {
     ...
     * Game timers.
     */
    public static final int GAME_TIMER = 200; //1500 * 600 = 900000ms = 15 minutes
    public static final int WAIT_TIMER = 45;
    ...
    private static int gameStartTimer = WAIT_TIMER;
    ...
    public static void toWaitingRoom(Client player, int team) {
        if (team == 1) {
            ...
            if (getZammyPlayers() >= getSaraPlayers() || getSaraPlayers() == 0) {
                ...
                player.sendMessage("Next Game Begins In: " + (gameStartTimer) + " seconds.");
        ...
        while (iterator.hasNext()) {
            ...
            if (scores[0] == scores[1]) {
                ...
                if (scores[0] > scores[1]) {
                    ...
                    player.sendMessage("You lost the CastleWars Game. You received 1 CastleWars Tickets!");
                }
            } else if (team == 2) {
