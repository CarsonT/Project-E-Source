...
private Tile currentTile;
	...
	**/
	public void getRandomAndHomeNPCWalking(int i) {
		direction = -1;
		if(Server.npcHandler.getNPCs()[i].freezeTimer == 0) {
	...
	**/
	...
	public boolean inMulti() {
		if((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607) || 
			...
			(absX >= 3191 && absX <= 3153 && absY >= 2967 && absY <= 3000) ||
			(absX >= 2785 && absX <= 2811 && absY >= 2771 && absY <= 2799) ||
			(absX >= 2371 && absX <= 2422 && absY >= 5062 && absY <= 5117) ||
			(absX >= 2896 && absX <= 2927 && absY >= 3595 && absY <= 3630) ||
			(absX >= 2892 && absX <= 2932 && absY >= 4435 && absY <= 4464) ||
			(absX >= 2256 && absX <= 2287 && absY >= 4680 && absY <= 4711 ||
			(absX >= 3153 && absX <= 3191 && absY >= 3000 && absY <= 2967) ||
			(absX >= 3154 && absX <= 3191 && absY >= 3000 && absY <= 2967) ||
			(absX > 3153 && absX < 3190 && absY > 2964 && absY < 2997) ||
			(absX > 3488 && absX < 3514 && absY > 3565 && absY < 3585) ||
			absX > 2689 && absX < 2749 && absY > 5060 && absY < 5123)) {
			return true;
		}
		return false;
	}
