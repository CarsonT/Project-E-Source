...
public class Food {
	...
	public boolean hasFullPrimal() {
    		return c.playerEquipment[c.playerHat] == 13362 && c.playerEquipment[c.playerChest] == 13358 && c.playerEquipment[c.playerLegs] == 13360;
  	}
	...
	public boolean torva() {
		if (c.playerEquipment[c.playerHat] == 13362 && c.playerEquipment[c.playerLegs] == 13360 && c.playerEquipment[c.playerChest] == 13358
		|| c.playerEquipment[c.playerHat] == 20147 && c.playerEquipment[c.playerLegs] == 20151 && c.playerEquipment[c.playerChest] == 20155
		|| c.playerEquipment[c.playerHat] == 20159 && c.playerEquipment[c.playerLegs] == 20163 && c.playerEquipment[c.playerChest] == 20167) {
			return true;
		}
		return false;
	}
	...
	/*public void eat(int id, int slot) {
        ...
        if (!c.isDead && System.currentTimeMillis() - c.foodDelay >= 1500) {
	...
	public void eat(int id, int slot) {
        ...
        if (!c.isDead && System.currentTimeMillis() - c.foodDelay >= 1500) {
            int maxHp = hasFullPrimal() ? c.getLevelForXP(c.playerXP[3]) + c.primalBoost : c.getLevelForXP(c.playerXP[3]);
			c.getCombat().resetPlayerAttack();
			c.attackTimer += 2;
			c.startAnimation(829);
			c.getItems().deleteItem(id,slot,1);
