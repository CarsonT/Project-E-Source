...
import server.model.players.packets.bank.Bank10;
import server.model.players.packets.bank.Bank5;
import server.model.players.packets.bank.BankAll;
import server.model.players.packets.bank.BankX1;
import server.model.players.packets.bank.BankX2;
...
import server.model.players.packets.item.ClickItem;
import server.model.players.packets.clicking.ClickNPC;
import server.model.players.packets.clicking.ClickObject;
import server.model.players.packets.clicking.ClickingButtons;
import server.model.players.packets.clicking.ClickingInGame;
import server.model.players.packets.clicking.ClickingStuff;
import server.model.players.packets.Commands;
import server.model.players.packets.Dialogue;
import server.model.players.packets.item.DropItem;
import server.model.players.packets.FollowPlayer;
import server.model.players.packets.IdleLogout;
import server.model.players.packets.item.ItemClick2;
import server.model.players.packets.item.ItemClick3;
import server.model.players.packets.item.ItemOnGroundItem;
import server.model.players.packets.item.ItemOnItem;
import server.model.players.packets.item.ItemOnNpc;
import server.model.players.packets.item.ItemOnObject;
import server.model.players.packets.item.MagicOnFloorItems;
import server.model.players.packets.item.MagicOnItems;
import server.model.players.packets.item.MoveItems;
import server.model.players.packets.item.PickupItem;
import server.model.players.packets.PrivateMessaging;
import server.model.players.packets.item.RemoveItem;
...
import server.model.players.packets.item.WearItem;
import server.model.content.Report;
