	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		switch(packetType) {
			...
			**/
			...
			if(c.getCombat().correctBowAndArrows() < c.playerEquipment[c.playerArrows] && Config.CORRECT_ARROWS && usingBow && !c.getCombat().usingCrystalBow() && !usingCross && c.playerEquipment[c.playerWeapon] != 18357 && c.playerEquipment[c.playerWeapon] != 9185) {
