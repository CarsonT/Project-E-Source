...
public class ShopAssistant {
	...
	**/
	...
	public void buyFromShopPrice(int removeId, int removeSlot){
		...
		if (c.myShopId == 78) {
			c.sendMessage("[<col=9930FF>*</col>] <col=9930FF>" + c.getItems().getItemName(removeId)+" </col>currently costs <col=9930FF>" + getSpecialItemValue(removeId) + " </col>achievements points.");
			return;
		}	
		if (c.myShopId == 77) {
			c.sendMessage("[<col=9930FF>*</col>] <col=9930FF>" + c.getItems().getItemName(removeId)+" </col>currently costs <col=9930FF>" + getSpecialItemValue(removeId) + " </col>frost points.");
			return;
		}		
		if (c.myShopId == 17) {
			c.sendMessage("[<col=9930FF>*</col>] <col=9930FF>" + c.getItems().getItemName(removeId)+" </col>currently costs <col=9930FF>" + getSpecialItemValue(removeId) + " </col>Project-E points.");
			return;
		}			
		if (c.myShopId == 45) {
			c.sendMessage("[<col=9930FF>*</col>] <col=9930FF>" + c.getItems().getItemName(removeId)+" </col>currently costs <col=9930FF>" + getSpecialItemValue(removeId) + " </col>vote points.");
			return;
		}	
		if (c.myShopId == 18) {
			c.sendMessage("[<col=9930FF>*</col>] <col=9930FF>" + c.getItems().getItemName(removeId)+" </col>currently costs <col=9930FF>" + getSpecialItemValue(removeId) + " </col>Project-E points.");
	...
	**/
	...
	if (System.currentTimeMillis() - c.lastButton > 15000) {
		...
		public void handleOtherShop(int itemID) {
			if (c.myShopId == 17) {
				if (c.pePoints >= getSpecialItemValue(itemID)) {
					if (c.getItems().freeSlots() > 0){
						c.pePoints -= getSpecialItemValue(itemID);
						c.getItems().addItem(itemID,1);	
						c.getItems().resetItems(3823);
					}
				} else {
				...
				if (c.pePoints >= getSpecialItemValue(itemID)) {
					...
					if(c.getItems().getItemName(itemID).endsWith("s")) 
						c.sendMessage("[<col=9930FF>*</col>] You have purchased <col=9930FF>" + c.getItems().getItemName(itemID) + " </col>for <col=9930FF>" + getSpecialItemValue(itemID) + " </col>Project-E points!");
					else 
						c.sendMessage("[<col=9930FF>*</col>] You have purchased a <col=9930FF>" + c.getItems().getItemName(itemID) + " </col>for <col=9930FF>" + getSpecialItemValue(itemID) + " </col>Project-E points!");
					}
				} else {
					c.sendMessage("[<col=9930FF>*</col>] You do not have enough points to buy this item.");			
				}
				...
				if (c.votePoints >= getSpecialItemValue(itemID)) {
					if (c.getItems().freeSlots() > 0){
						...
						c.getItems().resetItems(3823);
					if(c.getItems().getItemName(itemID).endsWith("s")) 
						c.sendMessage("[<col=9930FF>*</col>] You have purchased <col=9930FF>" + c.getItems().getItemName(itemID) + " </col>for <col=9930FF>" + getSpecialItemValue(itemID) + " </col>vote points!");
					else 
						c.sendMessage("[<col=9930FF>*</col>] You have purchased a <col=9930FF>" + c.getItems().getItemName(itemID) + " </col>for <col=9930FF>" + getSpecialItemValue(itemID) + " </col>vote points!");
					}
				} else {
				...
				if (c.pePoints >= getSpecialItemValue(itemID)) {
					...
					c.sendMessage("[<col=9930FF>*</col>] You do not have enough P-E points to buy this item.");			
				}
